...
class T2T_Flickr_Widget extends WP_Widget {
	function T2T_Flickr_Widget() {
		...
		$this->WP_Widget('t2t_flickr', $themename.__(' - Flickr', 'framework'), $widget_ops, $control_ops);
	}
...
class T2T_Reviews_Widget extends WP_Widget {
	function T2T_Reviews_Widget() {
		...
		$this->WP_Widget('t2t_reviews', $themename.__(' - Reviews', 'framework'), $widget_ops, $control_ops);
	}
...
class T2T_Location_Widget extends WP_Widget {
	function T2T_Location_Widget() {
		...
		$control_ops = array('width' => 200, 'height' => 200);
		$this->WP_Widget('t2t_location', $themename.__(' - Location', 'framework'), $widget_ops, $control_ops);
	}
        ...
        ?>
			...
			<?php echo $before_widget; ?>
				...
				<div class="location_widget">
					...
					<p>
					<?php if($phone != "") { ?><span class="icon general">r</span> <?php echo $phone; ?><br/><?php } ?>
					<?php if($fax != "") { ?><span class="icon general">'</span> <?php echo $fax; ?><br/><?php } ?>
					<?php if($email != "") { ?><span class="icon general">h</span> <a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a></p><?php } ?>
					<p>
				</div>
			<?php echo $after_widget; ?>
...
class T2T_Video_Widget extends WP_Widget {
	function T2T_Video_Widget() {
		...
		$control_ops = array('width' => 200, 'height' => 200);
		$this->WP_Widget('t2t_video', $themename.__(' - Video', 'framework'), $widget_ops, $control_ops);
	}
...
class T2T_Gallery_Widget extends WP_Widget {
	function T2T_Gallery_Widget() {
		...
		$control_ops = array('width' => 200, 'height' => 200);
		$this->WP_Widget('t2t_gallery', $themename.__(' - Gallery', 'framework'), $widget_ops, $control_ops);
	}
