...
function toggle_slider_options(t_type) {
	jQuery("#"+$themeshortname+"_slider_animation").parent().parent().toggle();
	jQuery("#"+$themeshortname+"_autoplay_duration").parent().parent().toggle();
	jQuery("#"+$themeshortname+"_pause_duration").parent().parent().toggle();
	jQuery("#"+$themeshortname+"_slide_2_upload, #"+$themeshortname+"_slide_3_upload, #"+$themeshortname+"_slide_4_upload, #"+$themeshortname+"_slide_5_upload").parent().parent().parent().toggle();
}
...
jQuery(document).ready(function() {
	...
	jQuery('.widget .add_review').live('click', function(){
			var field_id = jQuery(this).attr("rel");
      jQuery(this).parent().append('<p><label for="'+field_id+'[]">Review (<a href="javascript:;" class="remove_review file-error">delete</a>):</label><textarea class="widefat" name="'+field_id+'[]"></textarea></p>');
  });

	jQuery('.widget .remove_review').live("click", function(){
